# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 07:59:08 2024

@author: Priyanka
"""

"""
Perform multilinear regression with price as the output variable and document 
the different RMSE values.multiple correlation regression analysis

What is the business objective?
One reason both analyses mentioned is higher computer prices for consumers, which has been noted 
was due to higher prices for certain components, namely memory chips and other perpherals ,
The main objective is to establish relation among these with price of computer.
...
import pandas as pd
import numpy as np
comp=pd.read_csv("C:\Data Set\Multilinear_Regression\Computer_Data.csv")
comp.columns
comp.dtypes
