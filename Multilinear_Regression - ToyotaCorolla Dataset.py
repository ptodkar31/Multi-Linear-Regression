# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 07:59:01 2024
...
by applying multilinear regression on the given dataset. Please use the below 
columns for the analysis purpose: price, age_08_04, KM, HP, cc, Doors, Gears, 
...
cars=pd.read_csv("C:\Data Set\Multilinear_Regression\ToyotaCorolla.csv",encoding='ISO-8859-1')
